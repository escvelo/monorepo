...
void detectEars( Mat frame )
{
    ...
    // Detect left ears
    leftear_cascade.detectMultiScale( frame_gray, leftears, 1.1, 2, 0|CASCADE_SCALE_IMAGE, Size(30, 30) );
    
    // Detect right ears
    rightear_cascade.detectMultiScale( frame_gray, rightears, 1.1, 2, 0|CASCADE_SCALE_IMAGE, Size(30, 30) );
...
void detectMouth( Mat frame )
{
    ...
    // Detect mouth
    mouth_cascade.detectMultiScale( frame_gray, mouths, 1.1, 2, 0|CASCADE_SCALE_IMAGE, Size(30, 30) );
...
void detectSmile( Mat frame )
{
    ...
    // Detect faces
    smile_cascade.detectMultiScale( frame_gray, smiles, 1.1, 2, 0|CASCADE_SCALE_IMAGE, Size(30, 30) );
...
void detectUpperBody( Mat frame )
{
    ...
    // Detect faces
    upperbody_cascade.detectMultiScale( frame_gray, upperbody, 1.1, 2, 0|CASCADE_SCALE_IMAGE, Size(100, 100) );
...
void detectLowerBody( Mat frame )
{
    ...
    // Detect faces
    lowerbody_cascade.detectMultiScale( frame_gray, lowerbody, 1.1, 2, 0|CASCADE_SCALE_IMAGE, Size(100, 100) );
...
void detectFullBody( Mat frame )
{
    ...
    // Detect faces
    fullbody_cascade.detectMultiScale( frame_gray, fullbody, 1.1, 2, 0|CASCADE_SCALE_IMAGE, Size(100, 100) );
